...
{if $config['payment_system'] == 'mgate'}
<div class="modal fade" tabindex="-1" role="dialog" id="mgate-modal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">支付</h5>
      ...
      <div class="modal-footer bg-whitesmoke br">
        <a id="to-mgate" href="##" type="button" target="blank" class="btn btn-primary">继续支付</a>
      </div>
    </div>
  </div>
</div>
